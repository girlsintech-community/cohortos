...
import { Loader2, Linkedin, Github, MapPin, GraduationCap, Trophy, Flame, Zap, ArrowLeft } from "lucide-react";
...
function MemberProfilePage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <Link to="/dashboard" className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-primary"><ArrowLeft className="h-4 w-4" /> Back to dashboard</Link>
          ...
          <div className="flex flex-col sm:flex-row gap-6 -mt-12">
            ...
            <div className="flex-1 sm:pt-12">
              <div className="flex flex-wrap items-center gap-2">
                ...
                {profile.primary_role && <Badge variant="secondary" className="capitalize">{profile.primary_role.replace("_", " ")}</Badge>}
              </div>
