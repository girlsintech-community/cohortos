...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Cohort OS" },
      { property: "og:description", content: "The gamified home base for the DSA cohort. XP, streaks, leaderboards, discussions, and challenges." },
